...
import { Plan, CreatePlanDto, UpdatePlanDto } from '@/services/plans'
...
export function PlanFormModal({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (error.response?.data?.message) {
        ...
        setErrors({ general: 'Erro ao salvar plano' })
      }
    } finally {
      setIsLoading(false)
    }
  ...
  const handleInputChange = (field: keyof CreatePlanDto, value: any) => {
