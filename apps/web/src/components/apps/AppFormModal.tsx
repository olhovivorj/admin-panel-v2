...
import { App, CreateAppDto, UpdateAppDto } from '@/services/apps'
...
export function AppFormModal({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (error.response?.data?.message) {
        ...
        setErrors({ general: 'Erro ao salvar app' })
      }
    } finally {
      setIsLoading(false)
    }
  ...
  const handleInputChange = (field: keyof CreateAppDto, value: any) => {
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Ex: FiUsers, FiSettings"
                />
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  Nome do ícone (Feather Icons)
                </p>
              </div>
            ...
            >
              {isLoading ? (
                ...
                <>
                  ...
                  {isEdit ? 'Salvar Alterações' : 'Criar App'}
                </>
              )}
            </button>
            <button
